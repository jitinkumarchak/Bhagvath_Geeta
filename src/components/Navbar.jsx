...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "0.6rem", marginRight: "auto" }}>
          ...
          {NAV_LINKS.map(link => {
            ...
            return (
              <Link
                ...
                onMouseEnter={e => { if (!active) e.currentTarget.style.background = "rgba(245,200,66,0.08)"; }}
        ...
        <button
          ...
          style={{
            ...
            color: "var(--color-text)", fontSize: "1.4rem", padding: "0.3rem",
          }}
